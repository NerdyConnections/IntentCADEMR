...
{
    public class ValidateApplicableTax: ValidationAttribute
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            {
                if (string.IsNullOrEmpty(pfm.ApplicableTax))
                {
                    return new ValidationResult("Please enter applicable tax");
                }
